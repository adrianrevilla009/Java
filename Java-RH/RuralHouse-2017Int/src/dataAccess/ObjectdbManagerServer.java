...
public class ObjectdbManagerServer extends JDialog {
	...
	public ObjectdbManagerServer() {
					...
					public void actionPerformed(ActionEvent e) {
					    ...
					    try {
					    	System.out.println("Server close");
					    	 try {
							    	Runtime.getRuntime().exec("java -cp libs\\objectdb.jar com.objectdb.Server -port "+ c.getDatabasePort()+" stop");
							    } catch (Exception ioe) {
		...
		try{
			...
			try {
		    	Runtime.getRuntime().exec("java -cp libs\\objectdb.jar com.objectdb.Server -port "+ c.getDatabasePort()+" start");
		    } catch (Exception ioe) {
		    	System.out.println (ioe);
		    }
