  ...
  private void jbInit() throws Exception
  {
    ...
    table.addMouseListener(new MouseAdapter() {
    	...
    	public void mouseClicked(MouseEvent e) {
    		...
    		Offer offer = (Offer) tableModel.getValueAt(i,0);
    		Integer houseN = (Integer) tableModel.getValueAt(i,1);
			...
			BookRuralHouseGUI b=new BookRuralHouseGUI(houseN.intValue(),offer,firstDate,lastDate);
			b.setVisible(true);
       		}
    });
